...
if test "$PHP_GRPC" != "no"; then
  ...
  PHP_NEW_EXTENSION(grpc,
    ...
    src/core/lib/event_engine/cf_engine/cfrunloop_poller.cc \
    src/core/lib/event_engine/cf_engine/cfstream_client.cc \
    ...
    -DGRPC_XDS_USER_AGENT_VERSION_SUFFIX='"\"1.52.0dev\""')
