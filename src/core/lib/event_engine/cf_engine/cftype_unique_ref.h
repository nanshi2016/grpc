...
#ifndef GRPC_CORE_LIB_EVENT_ENGINE_CF_ENGINE_CFTYPE_UNIQUE_REF_H
#define GRPC_CORE_LIB_EVENT_ENGINE_CF_ENGINE_CFTYPE_UNIQUE_REF_H
...
class CFTypeUniqueRef {
 ...
 public:
  ...
  ~CFTypeUniqueRef() { release(); }

  CFTypeUniqueRef(CFTypeUniqueRef const&) = delete;
  CFTypeUniqueRef& operator=(CFTypeUniqueRef const&) = delete;

  CFTypeUniqueRef(CFTypeUniqueRef&& other) {
    cf_type_ref_ = other.cf_type_ref_;
    other.cf_type_ref_ = nullptr;
  };
...
#endif  // GRPC_CORE_LIB_EVENT_ENGINE_CF_ENGINE_CFTYPE_UNIQUE_REF_H