...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/lib/event_engine/cf_engine/cfrunloop_poller.cc )
  s.files += %w( src/core/lib/event_engine/cf_engine/cfrunloop_poller.h )
  s.files += %w( src/core/lib/event_engine/cf_engine/cfstream_client.cc )
  s.files += %w( src/core/lib/event_engine/cf_engine/cfstream_client.h )
